    ...
    useEffect(() => {
        const timer = setTimeout(async () => {
            ...
            if (sanitizedQuery.length > 0) {
                setIsSearching(true);
                try {
                    const res = await searchProducts(sanitizedQuery);
                    if (res && res.success) {
                                ...
                                {searchResults.map((product) => {
                                    ...
                                    return (
                                        <Link 
                                            ...
                                            className="flex items-center gap-4 p-3 rounded-[var(--radius-md)] hover:bg-[var(--bg-soft)] cursor-pointer group transition-all text-left"
                                        >
                                            <div className="w-14 h-14 bg-[var(--bg-soft)] rounded-[var(--radius-sm)] overflow-hidden flex items-center justify-center p-2 group-hover:bg-[var(--bg)] border border-transparent group-hover:border-[var(--border)] shrink-0">
                                            ...
                                            <button 
                                                ...
                                                className="p-2 bg-[var(--bg)] border border-[var(--primary)] text-[var(--primary)] rounded-lg hover:bg-[var(--primary)] hover:text-[var(--secondary)] transition-all scale-0 group-hover:scale-100 shadow-[var(--shadow-sm)] shrink-0"
                                            >
