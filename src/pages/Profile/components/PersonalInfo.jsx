      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-1">
        ...
        <div className="flex-1 flex flex-col w-full">
          ...
          <div className="mb-10 flex flex-col items-center justify-center w-full">
            <div 
              className={`relative w-28 h-28 rounded-full flex items-center justify-center overflow-hidden border-4 bg-[var(--bg-soft)] shadow-[var(--shadow-md)] transition-all group ${isEditing ? 'border-[var(--primary)] cursor-pointer' : 'border-[var(--border)]'}`} 
            ...
            >
              {formData.avatar ? (
                ...
                <PersonOutlineOutlinedIcon style={{ fontSize: '40px' }} className="opacity-30" />
              )}
              {isEditing && (
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                  <CameraAltOutlinedIcon className="text-white scale-75" />
                </div>
              )}
            </div>
        ...
        {isEditing && (
          <div className="flex items-center justify-end gap-4 pt-8 mt-10 border-t border-[var(--border)]">
            ...
            <button 
              ...
              className={`px-8 py-3 rounded-[var(--radius-pill)] font-black uppercase tracking-widest text-[12px] shadow-md bg-[var(--primary)] text-[var(--secondary)] transition-all ${isSubmitting ? 'opacity-70 cursor-not-allowed' : 'hover:bg-[var(--primary-hover)] hover:-translate-y-1'}`}
            >
